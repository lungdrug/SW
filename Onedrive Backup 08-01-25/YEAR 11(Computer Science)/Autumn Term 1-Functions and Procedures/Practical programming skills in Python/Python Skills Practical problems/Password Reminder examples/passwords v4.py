...
# Function to encrypt a password and return it back
...
# Set a choice so that it will trigger the while loop
choice = 9

# Repeat until the user enters 0
while choice != 0:
    # Get and validate a user choice
    displayMenu()
